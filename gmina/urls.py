...
urlpatterns = [
    ...
    path(
        "ludnosc/", include("ewidencja_ludnosci.urls", namespace="ewidencja_ludnosci")
    ),
    path(
        "zbiorniki/",
        include("ewidencja_zbiornikow.urls", namespace="ewidencja_zbiornikow"),
    ),
    path("odpady/", include("odpady.urls", namespace="odpady")),
    path("podatki/", include("podatki.urls", namespace="podatki")),
    path(
        "rejestracja_samochodu/",
        include("rejestracja_samochodu.urls", namespace="rejestracja_samochodu"),
    ),
]
